...
### Fixed
- Auto-updater: check for updates automatically when opening Settings, show download progress, and restart after install.
- Author attribution: updated About page links, repository URLs, and credits to @igect across all 10 language translations.
