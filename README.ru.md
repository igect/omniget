...
Если вы представляете указанную платформу и у вас есть вопросы, напишите на **buyfragments@gmail.com** с корпоративного адреса. Платформа будет убрана из списка сразу же.
