...
- **Дополнительные настройки:** Задавайте собственную папку вывода, загружайте файлы cookies для скачивания приватного или ограниченного контента, а также выбирайте тип контента (только изображения, только видео или всё сразу).
