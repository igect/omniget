<script lang="ts">
    ...
    async function openAuthorGithub(e: Event) {
        e.preventDefault();
        await open("https://github.com/igect");
    }
</script>
...
<div class="about-overview">
    ...
    <div class="about-external">
        <a href="https://github.com/igect/omniget" target="_blank" rel="noopener" class="btn about-ext-link">
    ...
    <footer class="about-footer">
        ...
        <a href="https://github.com/igect" class="about-watermark" onclick={openAuthorGithub} title="@igect">
            @igect
        </a>
    </footer>
</div>
