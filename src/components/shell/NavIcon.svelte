...
{:else}
  ...
  >
    ...
    {:else if icon === "open_omni"}
      ...
      <path d="M3.6 9h16.8M3.6 15h16.8" fill="none" stroke="currentColor" stroke-width="1.6" />
      <path d="M11.5 3.2a16.5 16.5 0 0 0 0 17.6M12.5 3.2a16.5 16.5 0 0 1 0 17.6" fill="none" stroke="currentColor" stroke-width="1.6" />
