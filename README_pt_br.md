...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      <br/>
      <sub>Baixe o <code>.exe</code> em Releases e dê dois cliques. Ele é portátil, então roda de qualquer pasta. Também existe um instalador <code>.msi</code> e o comando <code>winget install -e --id igect.OmniGet</code>, se você preferir a linha de comando.</sub>
    </td>
  </tr>
  <tr>
